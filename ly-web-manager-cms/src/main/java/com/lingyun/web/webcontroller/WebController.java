...
public class WebController {
	...
	private static final String
			APP_KEY="eeb72b5ea1e34fe879dfb775ac34f8fd";
	//网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
	private static final String APP_SECRET="4a702ca30227";
	//随机数
	...
	public void getCode(String phoneNumber) throws Exception {
		...
		String checkSum = CheckSumbulider.getCheckSum(APP_SECRET, NONCE, curTime);
